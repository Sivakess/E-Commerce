        ...
        <div className='flex items-center gap-6'>
           ...
           <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                  <div className='flex flex-col text-gray-600'>  
                    ...
                    <div onClick={()=> setvisible(false)} className='flex item-center  gap-4 p-3 text-gray-700 cursor-pointer' >
                        <img className='h-4 rotate-180' src={assets.dropdown_icon} alt="" />
                        <p>Back</p>
                    </div>
                    <NavLink onClick={()=>setvisible(false)} className='py-2 pl-6 border text-gray-700 text-decoration-none' to='/'>HOME</NavLink>
                    <NavLink onClick={()=>setvisible(false)} className='py-2 pl-6 border text-gray-700 text-decoration-none' to='/collection'>COLLETION</NavLink>
                    <NavLink onClick={()=>setvisible(false)} className='py-2 pl-6 border text-gray-700 text-decoration-none' to='/about'>ABOUT</NavLink>
                    <NavLink onClick={()=>setvisible(false)} className='py-2 pl-6 border text-gray-700 text-decoration-none' to='/contact'>CONTACT</NavLink>
                    </div>            
            </div>     
